  ...
  return (
    <>
      ...
      <Link
        ...
        className="hover:scale-110 relative group duration-500 overflow-hidden"
      >
        ...
        <div className="z-50 group-hover:opacity-100 p-3 opacity-0 duration-500 absolute left-0 top-0 w-full h-auto overflow-hidden rounded-lg bg-black">
        ...
        <Image
          className={`group-hover:opacity-50 group-hover:scale-110 duration-500 overflow-hidden rounded-xl ${
