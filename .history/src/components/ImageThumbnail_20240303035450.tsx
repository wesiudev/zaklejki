  ...
  return (
    <>
      ...
      >
        ...
        />
        <div
          className={`group rounded-md flex flex-col items-center justify-center w-max h-max ${
            isLoading
        ...
        >
          <FaImage
            className={`group-hover:opacity-50 duration-500 rounded-md absolute left-[50%] -translate-x-[50%] top-[50%] -translate-y-[50%] h-12 w-12 text-white`}
          />
          <div className="w-full h-full relative">
            <div className="group-hover:opacity-100 opacity-0 duration-500 absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-4/5 h-auto overflow-hidden rounded-3xl mt-6">
