...
export default async function Checkout({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="text-center bg-gradient-to-br from-zinc-600 via-zinc-400 to-zinc-600 w-screen h-screen flex items-center justify-center flex-col">
      <Link
        href="/"
        className="text-white font-bold text-xl flex flex-row items-center z-50 fixed top-24 left-12"
      >
        <FaArrowLeft className="mr-2" />
        Powrót
      </Link>
      ...
      <div className="">
        ...
        {order.payment_status === "unpaid" && (
          <div className="bg-gradient-to-br from-zinc-600 via-zinc-400 to-zinc-600 w-screen h-screen flex items-center justify-center flex-col">
            {" "}
            <h1 className="text-3xl font-bold text-center">
