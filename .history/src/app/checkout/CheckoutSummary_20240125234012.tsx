    ...
    <div className="flex flex-col  justify-center w-full h-full">
      <>
        <button
          ...
          className="text-white font-bold text-xl flex flex-row items-center mb-12 px-3"
        >
          <FaArrowLeft className="mr-2" />
          Powrót
        </button>
        <h2 className="mb-3 px-3 text-base text-[#A5B4FC]">Do zapłaty</h2>
        <span className="text-[30px] xl:text-[38px]  font-bold text-white px-3">
          {price > 50
            ? getPolishCurrency(price)
            : getPolishCurrency(price + 9, 90)}
        </span>
        <div className="grid grid-cols-1 mt-16 text-white w-full px-3">
          <div>
            <div className="flex flex-row items-start justify-between w-full">
              <div className="flex flex-row w-full items-start justify-start h-full">
                ...
                <div className="pl-2 w-2/3">
                  <h2 className="text-2xl">Wodoodporny Putin</h2>
                </div>
              </div>
