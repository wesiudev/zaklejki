          ...
          <div className="flex mt-12 flex-col">
            ...
            <ul>
              <li className="flex flex-row items-start mt-6">
                ...
                Wodoodporne: Naklejki są wykonane z wysokiej jakości materiałów,
                które zapewniają ochronę przed wilgocią i wodą. Możesz śmiało
                używać ozdobionych nimi przedmiotów nawet w deszczowe dni.
              </li>
              <li className="flex flex-row items-start mt-3">
                ...
                Estetyczny design: Oferujemy różnorodne wzory i kształty, które
                pozwolą Ci dopasować naklejkę do Twojego stylu. Od
                abstrakcyjnych motywów po urocze ilustracje – mamy wszystko, co
                potrzebne do stworzenia unikalnej aranżacji.
              </li>
              <li className="flex flex-row items-start mt-3">
                <div>
                  <FaStar className="mr-2 text-yellow-400 h-5 w-5 text-5xl mt-[2px]" />
                </div>
                Łatwe aplikowanie: Naklejki są łatwe do nakładania i usuwania,
                nie pozostawiając śladów ani uszkodzeń. Dzięki temu możesz
                zmieniać ich położenie i tworzyć nowe kompozycje wedle własnego
                uznania.
              </li>
            </ul>
          </div>
