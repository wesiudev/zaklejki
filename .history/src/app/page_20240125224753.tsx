          ...
          <div className="flex mt-12 flex-col">
            ...
            <ul>
              ...
              <li className="flex flex-row items-start mt-3">
                ...
                <strong>Estetyczny design</strong> <br />
              ...
              <li className="flex flex-row items-start mt-3">
                ...
                <br /> Naklejki są łatwe do nakładania i usuwania, nie
                pozostawiając śladów ani uszkodzeń. Dzięki temu możesz zmieniać
                ich położenie i tworzyć nowe kompozycje wedle własnego uznania.
              </li>
            </ul>
          </div>
        </div>
