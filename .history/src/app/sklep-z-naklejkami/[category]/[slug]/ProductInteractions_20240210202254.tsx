    ...
    <div>
      ...
      <div className="grid grid-cols-3 mt-3 gap-3 mb-3">
        {!cartItems?.some((item: any) => item?.size?.includes("small")) ? (
          ...
          <div
            className={`text-center px-4 w-full py-2 rounded-3xl  bg-opacity-50 bg-gray-500 cursor-not-allowed duration-300 text-white font-bold ${
        ...
        {!cartItems?.some((item: any) => item?.size?.includes("large")) ? (
          ...
          <div
            className={`text-center border-2 border-transparent px-4 w-full py-2 rounded-3xl  bg-opacity-50 bg-gray-500 cursor-not-allowed duration-300 text-white font-bold`}
          >
            14cm
          </div>
        )}
