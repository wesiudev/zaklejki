...
export default function Home() {
  ...
  return (
    <>
      <div className="z-50 p-3 lg:p-6 fixed left-1/2 top-1/2 -translate-y-1/2 -translate-x-1/2 w-max h-[80vh] overflow-y-scroll bg-white shadow-lg shadow-black rounded-xl">
        <div className="bg-[#312E81] rounded-xl px-3 w-full h-full py-24 flex flex-col text-white">
          <CheckoutSummary
