      ...
      <div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-3 mt-3 gap-3">
          ...
          <button
            ...
            className={`border-2 px-4 w-full py-2 rounded-3xl bg-gradient-to-br from-slate-500 via-slate-400 to-slate-500 duration-300 text-white font-bold ${
              paperType === "silver"
                ? "opacity-100"
                : "opacity-65 hover:opacity-100"
            }`}
          ...
          <button
            ...
            className={`border-2 px-4 w-full py-2 rounded-3xl bg-gradient-to-br from-yellow-500 via-yellow-300 to-yellow-500 duration-300 text-white font-bold ${
              paperType === "gold"
                ? "opacity-100"
                : "opacity-65 hover:opacity-100"
            }`}
