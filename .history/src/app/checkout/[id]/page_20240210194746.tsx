...
export default async function Checkout({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="text-center">
      ...
      <div className="bg-white w-full h-full flex items-center justify-center flex-col mt-36">
        ...
        {order.payment_status === "unpaid" && (
          <div className="bg-white w-full h-max mt-36 flex items-center justify-center flex-col">
            <h1 className="text-3xl font-bold text-center">
