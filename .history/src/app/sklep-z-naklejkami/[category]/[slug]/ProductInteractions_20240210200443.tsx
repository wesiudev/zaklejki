    ...
    <div>
      ...
      <div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-3 mt-3 gap-3">
          ...
          <button
            onClick={() => setPaperType("normal")}
            className={`border-2 border-slate-500 px-4 w-full py-2 rounded-3xl bg-gradient-to-br from-slate-500 via-slate-300 to-slate-500 duration-300 text-white font-bold opacity-80 hover:opacity-100 ${
