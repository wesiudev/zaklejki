      ...
      <div className="grid grid-cols-3 mt-3 gap-3 mb-3">
        {!cartItems?.some((item: any) => item?.size?.includes("small")) ? (
          <button
            ...
            className={`px-4 w-full py-2 rounded-3xl bg-[#FAA4F4] hover:bg-[#f06be7] duration-300 text-white font-bold opacity-80 ${
          ...
          <div
            className={`text-center px-4 w-full py-2 rounded-3xl border-2 border-gray-500 bg-opacity-50 bg-gray-500 cursor-not-allowed duration-300 text-white font-bold ${
        ...
        {!cartItems?.some((item: any) => item?.size?.includes("large")) ? (
          ...
          <div
            className={`text-center border-2 border-transparent px-4 w-full py-2 rounded-3xl border-2 border-gray-500 bg-opacity-50 bg-gray-500 cursor-not-allowed duration-300 text-white font-bold`}
          >
            14cm
          </div>
        )}
      ...
      <div>
        ...
        <div className="grid grid-cols-3 mt-3 gap-3">
          <button
            ...
            className={`px-4 w-full py-2 rounded-3xl bg-[#FAA4F4] hover:bg-[#f06be7] duration-300 text-white font-bold ${
              paperType === "normal"
          ...
          <button
            ...
            className={`px-4 w-full py-2 rounded-3xl bg-gradient-to-br from-slate-500 via-slate-400 to-slate-500 duration-300 text-white font-bold ${
              paperType === "silver"
                ? "opacity-100"
                : "opacity-65 hover:opacity-100"
            }`}
          ...
          <button
            ...
            className={`px-4 w-full py-2 rounded-3xl bg-gradient-to-br from-yellow-500 via-yellow-300 to-yellow-500 duration-300 text-white font-bold ${
              paperType === "gold"
                ? "opacity-100"
                : "opacity-65 hover:opacity-100"
            }`}
