    ...
    <div className="">
      ...
      <div className="">
        ...
        <div className="mt-12 lg:mt-24 h-max relative">
          <div className="flex flex-col-reverse lg:flex-row h-full w-full relative">
            <div className="lg:w-[60vw] xl:w-[50vw] h-full lg:bg-white md:bg-[#f7faf7] rounded-xl rounded-tl-[80px]">
              <Image
                src="/home-images/happyWoman.jpeg"
                width={1024}
                height={1024}
                alt=""
        ...
        <div className="mt-12 lg:mt-24 pb-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 lg:gap-6 mt-6 lg:mt-10">
            <div className="relative rounded-3xl overflow-hidden group">
              <div className="z-[250] flex flex-col justify-center items-center w-full h-full absolute left-0 top-0 bg-black bg-opacity-50 group hover:bg-opacity-70 duration-1000">
                ...
                <div className="w-full relative overflow-hidden pb-24">
                  <p className="text-gray-300 text-center absolute top-0 left-0 -translate-y-24 opacity-0 group-hover:opacity-100 group-hover:-translate-y-0 duration-1000 px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-24 text-sm sm:text-base lg:text-lg">
