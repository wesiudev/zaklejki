        ...
        <div className="mt-12 lg:mt-24 h-max relative">
          <div className="flex flex-col-reverse lg:flex-row h-full w-full relative">
            ...
            <div className="mb-12 lg:mb-0 flex flex-col lg:pl-4 xl:pl-12 font-coco text-zinc-800 min-h-full py-6">
              ...
              <div className="flex flex-row">
                <Link
                  className="text-base xl:text-xl mt-3 mg:mt-5 px-4 py-2 rounded-lg bg-indigo-600 hover:bg-indigo-700 duration-300 text-white w-full lg:w-max font-bold flex flex-row items-center justify-center"
                  href="/sklep"
                  title="Otwórz sklep"
                >
                  Sprawdź sklep
