    ...
    <div>
      ...
      <div className="mt-3 flex flex-col md:flex-row">
        <div className="flex flex-col lg:flex-row items-center">
          <div className="w-full md:mr-3 lg:w-[150px] h-max relative">
            <button
              onClick={() => {
                if (quantity > 1) {
              ...
              className="absolute left-0 rounded-l-3xl h-full pl-4 pr-3 bg-indigo-600 hover:bg-[#f87ff0b6] text-xl font-bold text-white flex items-center justify-center"
            >
              -
            </button>
            <button
              ...
              className="absolute right-0 rounded-r-3xl h-full pr-4 pl-3 bg-indigo-600 hover:bg-[#f87ff0b6] text-xl font-bold text-white flex items-center justify-center"
            >
              +
            </button>
            <input
        ...
        <div className="flex flex-col-reverse lg:flex-row items-center mt-4 md:mt-0">
          {/* <Link
            ...
            className="border-[#F87FF0] hover:bg-indigo-600 hover:text-white duration-300 border-2 text-center lg:mr-3 px-4 py-2 rounded-3xl text-zinc-500 w-full lg:w-max font-bold"
          >
            Utwórz własną
          </Link> */}
          <AddToCartBtn
