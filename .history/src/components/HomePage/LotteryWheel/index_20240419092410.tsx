            ...
            <div className="sm:bg-white flex-col flex rounded-3xl p-6 md:p-6 justify-center -translate-x-[23%] sm:-translate-x-0">
              <div className="flex flex-row w-full justify-between mb-3 ">
                ...
                <button
                  ...
                  } group hover:bg-indigo-600 border-2 border-[#F87FF0] overflow-hidden hidden sm:flex duration-300  text-white rounded-3xl flex-row items-center justify-between font-bold`}
                >
              ...
              <button
                onClick={() => setPrizeListOpen(!prizeListOpen)}
                className="z-[102] hover:bg-[#f87ff0e0] fixed bottom-5 right-1 flex sm:hidden duration-200 bg-indigo-600 text-white rounded-3xl flex-row items-center justify-between font-bold"
              >
