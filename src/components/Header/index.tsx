    ...
    <>
      ...
      <div className="z-[500] fixed top-0 left-0 bg-white border-gray-300 border-b flex flex-row items-center w-full justify-between px-4 md:px-8 lg:px-12 xl:px-20 2xl:px-32">
        <div className="flex flex-row items-center md:space-x-1 lg:space-x-6">
          ...
          <div className="flex-row md:flex hidden">
            <Link
              ...
              href="/sklep"
              className="hover:text-indigo-600 text-[14px] flex items-center px-3 py-6"
            >
              Sklep
            </Link>
            ...
            <div
              ...
              className="group "
            >
              <button className="group-hover:text-indigo-600 text-[14px] flex items-center px-3 py-6">
                Kategorie
            ...
            >
              <button className="group-hover:text-indigo-600 text-[14px] flex items-center px-3 py-6 lg:pr-12 xl:pr-24">
                O nas
                <IoChevronDownOutline className="ml-[2px] mt-[1px] group-hover:rotate-180 duration-150" />
              </button>
        ...
        <div className="md:space-x-3 lg:space-x-6 flex flex-row items-center">
          <Link
            ...
            className={`relative hidden md:block px-4 py-2 rounded-3xl bg-indigo-600 hover:bg-[#f87ff0b6] duration-300 text-white w-max font-bold`}
          >
            <div className="w-max -bottom-1.5 right-[50%] -translate-x-[50%] text-[12px] rounded-full py-[1px] px-[3px] text-white bg-green-600 animate-pulse absolute">
              Już niedługo!
            </div>
            Stwórz naklejkę
          </Link>
          <button
            ...
            className="p-2 bg-indigo-600 rounded-full hidden md:block hover:bg-[#f87ff0b6] duration-300 border-[#F87FF0] border-2"
          >
      ...
      >
        ...
        <Link
          href="/tworzenie-naklejek"
          onClick={() => setMenuShow(!isMenuShow)}
          className={`md:hidden px-4 py-2 rounded-3xl bg-indigo-600 hover:bg-indigo-500 text-white w-max font-bold`}
        >
          Stwórz naklejkę
        </Link>
        <button
