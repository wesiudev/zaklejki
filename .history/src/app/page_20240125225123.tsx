      ...
      <main className="grid grid-cols-1 md:grid-cols-2 px-4 md:px-8 lg:px-12 xl:px-20 2xl:px-32">
        ...
        <div className="p-4 md:p-6 lg:p-8 xl:p-10 2xl:p-12 !pt-0 flex-col">
          ...
          <div className="flex mt-12 flex-col">
            ...
            <div className="">
              <h2 className="text-5xl font-bold">Darmowa dostawa</h2>
              ...
              bardziej korzystne. Własna naklejka wedle uznania: Oferujemy
              również możliwość stworzenia własnej, spersonalizowanej naklejki.
              Wystarczy przesłać nam swój projekt, a my dostarczymy Ci unikatową
              naklejkę, która idealnie odzwierciedli Twój indywidualny styl.
              Pozwól swojej kreatywności rozkwitać i nadaj swoim przedmiotom
              niepowtarzalny charakter dzięki naszym ozdobnym naklejkom
              wodoodpornym. Zamów już teraz i spraw, by codzienność była pełna
              kolorów i wyrazistych wzorów!
            </div>
          </div>
        </div>
      </main>
