...
export default function HeroSlider() {
  ...
  return (
    <div
      className={`mt-24 relative w-full h-[50vh] overflow-hidden rounded-2xl lg:border-2 lg:border-indigo-600 drop-shadow-xl shadow-black`}
    >
      {[
        {
          id: 0,
            ...
            <div className="flex flex-col">
              ...
              <ul className="flex flex-row items-start justify-center mt-2 space-x-3 flex-wrap sm:flex-no-wrap">
                <li className="flex flex-row items-center">
                  <FaStar className="h-4 w-4 text-indigo-600 mr-2" />
                  Papier złoty
                </li>
