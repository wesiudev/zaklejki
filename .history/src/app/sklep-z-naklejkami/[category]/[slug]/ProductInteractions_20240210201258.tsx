      ...
      <div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-3 mt-3 gap-3">
          <button
            ...
            className={`border-2 border-transparent px-4 w-full py-2 rounded-3xl bg-[#FAA4F4] hover:bg-[#f06be7] duration-300 text-white font-bold ${
              paperType === "normal"
                ? "!bg-[#f06be7] border-[#f06be7] opacity-100 bg-opacity-80"
