      ...
      >
        ...
        {slide.link.title && (
          <Link
            ...
            } w-max px-3 py-1.5 rounded-lg text-white font-bold text-base sm:text-xl flex flex-row items-center border-2 border-[#F87FF0] bg-indigo-600 hover:bg-indigo-500 duration-300 mt-2 lg:mt-3`}
          >
            {slide.link.title}
