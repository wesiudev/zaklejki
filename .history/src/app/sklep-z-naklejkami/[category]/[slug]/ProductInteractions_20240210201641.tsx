...
export default function ProductInteractions({ product }: { product: any }) {
  ...
  return (
    <div>
      <span className="text-xl xl:text-2xl font-bold text-zinc-800 drop-shadow-xl shadow-black mt-2">
        Wybierz rozmiar
      </span>
      <div className="grid grid-cols-2 lg:grid-cols-3 mt-3 gap-3 mb-3">
        {!cartItems?.some((item: any) => item?.size?.includes("small")) ? (
          ...
          <div
            className={`text-center px-4 w-full py-2 rounded-3xl bg-gray-500 hover:bg-gray-400 duration-300 text-white font-bold ${
