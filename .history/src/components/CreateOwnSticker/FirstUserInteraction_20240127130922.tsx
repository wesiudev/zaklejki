          ...
          <>
            {loading !== 0 ? (
              <>
                ...
                <label
                  htmlFor="imgInput"
                  className="h-full w-full hover:underline flex-col bg-gray-500 bg-opacity-60 hover:bg-opacity-40 duration-300 flex items-center justify-center text-white cursor-pointer"
                >
