    ...
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 2xl:grid-cols-3 gap-6 lg:gap-12 ">
        {categories.map((item: any, i: any) => (
          <div
            key={i}
            className="p-3 drop-shadow-xl shadow-black rounded-lg aspect-square h-full w-full bg-indigo-300 flex items-center justify-center"
          >
            ...
            <Link
              ...
              className="mt-6 bg-indigo-600 hover:bg-indigo-500 duration-300 rounded-md text-white px-4 py-2 w-max mx-auto h-full"
            >
              Zobacz więcej
            </Link>
          </div>
