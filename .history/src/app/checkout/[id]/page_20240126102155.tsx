...
export default async function Checkout({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="text-center bg-gradient-to-br from-zinc-600 via-zinc-400 to-zinc-600 w-screen h-screen flex items-center justify-center flex-col overflow-x-hidden">
      <Link
        href="/"
