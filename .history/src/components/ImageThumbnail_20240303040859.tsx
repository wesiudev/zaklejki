    ...
    <>
      ...
      >
        {!isLoading && product?.title && (
          <div className="z-20 opacity-0 group-hover:opacity-100 group-hover:text-green-500 duration-300 absolute text-sm bottom-0 left-0 py-0.5 px-2 rounded-b-xl w-full text-center bg-black bg-opacity-50 text-gray-300 font-bold">
