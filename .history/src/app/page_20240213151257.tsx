          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 lg:gap-6 mt-6 lg:mt-10">
            ...
            <div className="relative rounded-3xl overflow-hidden mt-6 lg:mt-0 group">
              <div className="z-[50] flex flex-col justify-center items-center w-full h-full absolute left-0 top-0 bg-black bg-opacity-50 group hover:bg-opacity-70 duration-1000">
                ...
                <div className="w-full relative overflow-hidden pb-24">
                  <p className="text-gray-300 !text-center w-full absolute top-0 left-0 -translate-y-24 opacity-0 group-hover:opacity-100 group-hover:-translate-y-0 duration-1000 px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-24 text-sm sm:text-base lg:text-lg">
