...
export default function HeroSlider() {
  ...
  return (
    <div
      className={`relative w-full h-[55vh] sm:h-[50vh] overflow-hidden rounded-2xl lg:border-2 lg:border-[#F87FF0] drop-shadow-xl shadow-black`}
    >
      {[
        {
          id: 0,
          ...
          <button
            ...
            className={`${
              currentSlide === slideNumber
                ? "bg-zinc-900 bg-opacity-30 border-[#F87FF0]"
                : "bg-white bg-opacity-30 border-zinc-900"
            } h-5 w-5 rounded-full border-2 border-spacing-2  duration-200 flex items-center justify-center`}
            key={slideNumber}
          >
            <div
