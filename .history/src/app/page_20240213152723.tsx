  ...
  return (
    <div className="">
      ...
      <div className="">
        ...
        <h2 className="mt-12 lg:mt-24 pb-12 text-center text-2xl sm:text-3xl lg:text-4xl xl:text-5xl text-zinc-800 font-bold sm:w-max mx-auto drop-shadow-xl shadow-black">
          Naklejkowe nowości!
        </h2>
