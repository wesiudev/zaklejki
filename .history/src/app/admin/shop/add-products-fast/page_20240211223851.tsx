...
import ProductsInputs from "../../../../components/ProductsInput";
...
const ImageUploader = () => {
  ...
  return (
    <div className="h-full w-full p-6 bg-[#222430]">
      ...
      />
      <ProductsInputs files={selectedImages} />

      <div>
        <h2 className="text-white font-bold text-3xl my-4">Selected Images:</h2>
