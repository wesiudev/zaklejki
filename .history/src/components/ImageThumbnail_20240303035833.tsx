  ...
  return (
    <>
      ...
      >
        ...
        <div className="z-50 group-hover:opacity-100 opacity-0 duration-500 absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-auto overflow-hidden rounded-lg mt-6">
