  ...
  return (
    <>
      <button
        ...
        className="fixed z-[100] top-[62px] md:top-[70px] left-0 h-max w-full py-3 bg-[#F87FF0] text-white font-bold text-3xl xl:text-4xl"
      >
          ...
          <div className="overflow-x-hidden h-full md:py-12 overflow-y-scroll w-full flex flex-col items-center justify-center">
            <div className="sm:bg-white flex-col flex rounded-3xl p-6 md:p-6 justify-center -translate-x-[23%] sm:-translate-x-0">
              <div className="flex flex-row w-full justify-between mb-3 ">
                ...
                <button
                  ...
                  className={`${
                    prizeListOpen && "bg-[#f87ff0]"
                  } group hover:bg-[#f87ff0] border-2 border-[#F87FF0] overflow-hidden hidden sm:flex duration-300  text-white rounded-3xl flex-row items-center justify-between font-bold`}
                >
                  <div className="flex items-center justify-center bg-[#F87FF0] w-12 h-12">
              ...
              <button
                onClick={() => setPrizeListOpen(!prizeListOpen)}
                className="z-[102] hover:bg-[#f87ff0e0] fixed bottom-5 right-1 flex sm:hidden duration-200 bg-[#F87FF0] text-white rounded-3xl flex-row items-center justify-between font-bold"
              >
            ...
            {prize.title !== "" && (
              <div className="bg-white rounded-3xl fixed top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 h-max w-[90%] sm:w-[400px] flex flex-col items-center justify-center font-coco z-[1500]">
                <h2 className="text-white bg-[#F87FF0] font-bold w-full rounded-t-3xl p-6 text-2xl text-center">
                  Twoja promocja
                </h2>
                <Image
                  width={333}
