    ...
    <div>
      ...
      <div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-3 mt-3 gap-3">
          ...
          <button
            onClick={() => setPaperType("normal")}
            className={`border-2 border-slate-400 px-4 w-full py-2 rounded-3xl bg-gradient-to-br from-slate-400 via-slate-200 to-slate-400 duration-300 text-white font-bold opacity-80 hover:opacity-100 ${
