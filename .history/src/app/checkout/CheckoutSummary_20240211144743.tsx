...
export default function CheckoutSummary() {
  ...
  return (
    <div
      className={`flex mt-48 flex-col justify-center w-full h-full ${
    ...
    >
      {isLoading ? (
        ...
        <>
          ...
          {cart?.length !== 0 && (
            <>
              <h2 className="mb-3 px-3 sm:px-6 lg:px-24 text-base text-[#A5B4FC]">
                Do zapłaty
              </h2>
              {promotion !== -1 && (
                <div className="flex flex-row items-center px-3 sm:px-6  lg:px-24">
                  {message === "Kod aktywny" && (
              ...
              {promotion === -1 && (
                <span className="text-[30px] xl:text-[38px] font-bold text-white px-3 sm:px-6  lg:px-24">
                  {finalPrice >= 100
                    ? getPolishCurrency(finalPrice)
                    : getPolishCurrency(finalPrice + 10)}
                </span>
              ...
              {promotion !== -1 && (
                <div className="mt-4 px-3 sm:px-6  lg:px-24">
              ...
              <div className="grid grid-cols-1 mt-16 text-white w-full px-3 sm:px-6  lg:px-24">
