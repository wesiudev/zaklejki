...
export default function CheckoutSummary() {
  ...
  const cartPrice = getFinalPrice(promotion, cart);
  ...
  return (
    ...
    //               : getPolishCurrency(cartPrice + 10)}
    //           </span>
    //           <p className="mt-4 text-white px-6 sm:px-36 lg:px-24">
    //             Aktywny kupon {listOfPrizes[promotion]?.title}{" "}
    //           </p>
    ...
    //                 {cartPrice >= 100 && "Darmowa"}
    //                 {cartPrice < 100 && getPolishCurrency(10)}
    //               </p>
    //             </div>
    //             <div className="bg-[#e5e7eb] h-px my-4 opacity-10" />
    //             <div className="flex flex-row items-center justify-between w-full">
