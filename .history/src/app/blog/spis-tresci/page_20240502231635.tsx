export default function Page() {
  return (
    <div>
      ...
      <meta
        name="keywords"
        content="naklejki, naklejki z motywami, naklejki z filmów, naklejki z bajek, naklejki z fantastyki, naklejki sztuki, naklejki abstrakcyjne, naklejki smoków, naklejki abstrakcyjne, naklejki świata, naklejki z natury, naklejki ze smiesznych"
      />
    </div>
  );
}
