  ...
  return (
    <div>
      ...
      <div>
        ...
        <button
          onClick={() => setPaperType("normal")}
          className={`border-2 border-transparent px-4 w-full py-2 rounded-3xl bg-gradient-to-br from-slate-400 via-slate-200 to-slate-400 duration-300 text-white font-bold opacity-80 hover:opacity-100 ${
        ...
        <div className="grid grid-cols-2 lg:grid-cols-3 mt-3 gap-3"></div>
      </div>
      <span className="text-xl xl:text-3xl font-bold text-zinc-800 drop-shadow-xl shadow-black">
        Wybierz ilość
      </span>
