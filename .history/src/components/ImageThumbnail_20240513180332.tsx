          ...
          <div className="z-20 opacity-0 group-hover:opacity-100 duration-300 absolute text-sm bottom-0 left-0 w-full flex flex-col items-center justify-center">
            <div className="flex flex-row">
              <div className="text-center flex flex-col items-center">
                ...
                <div className="bg-green-400 text-white font-light">7,90zł</div>
              </div>
              <div className="text-center flex flex-col items-center">
                <div className="bg-blue-400 text-white font-bold text-lg p-1.5 rounded-md">
                  8cm
                </div>
                <div className="bg-blue-400 text-white font-light">12,90zł</div>
              </div>
              <div className="text-center flex flex-col items-center">
                <div className="bg-yellow-400 text-white font-bold text-lg p-1.5 rounded-md">
                  14cm
                </div>
                <div className="bg-yellow-400 text-white font-light">
                  17,90zł
                </div>
              </div>
            </div>
