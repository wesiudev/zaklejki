...
export default function CreateOwnSticker({
  ...
  return (
    <div className="z-[501] fixed left-1/2 top-1/2 -translate-y-1/2 -translate-x-1/2">
      <div
        className={`bg-[#312E81] relative lg:rounded-xl px-6 py-6 -mr-4 lg:mr-0 flex flex-col text-white h-screen w-screen ld:w-[90vw] lg:w-[80vw] xl:w-[70vw] duration-500 overflow-y-scroll ${
          emptyRows[0] === "" ? "lg:h-[60vh]" : "lg:h-[80vh]"
        }`}
      >
        <div className="flex flex-row items-center justify-between mb-3">
          ...
          <button
            onClick={() => setOwnStickerOpen(false)}
            className="bg-gray-400 bg-opacity-40 hover:bg-opacity-20 duration-300 rounded-md p-2"
          >
        ...
        {emptyRows[0] !== "" && (
          <div className="flex flex-col-reverse md:flex-row">
            ...
            <div className="h-max md:sticky top-12 aspect-square grid grid-cols-4 md:grid-cols-3 gap-3 w-full md:w-[40%]">
              {emptyRows.map((item: any, idx: number) => (
