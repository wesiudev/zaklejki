        ...
        <div className="p-4 md:p-6 lg:p-8 xl:p-10 2xl:p-12 !pt-0 flex-col">
          ...
          <div className="grid grid-cols-3 my-12 gap-3">
            <button
              ...
              className={`px-4 w-full py-2 rounded-3xl bg-[#F87FF0] hover:bg-[#f87ff0b6] duration-300 text-white font-bold ${
                quantity === 1 && "!border-2 border-rose-500"
              }`}
            >
              1
            </button>
            <button
              ...
              className={`px-4 w-full py-2 rounded-3xl bg-[#F87FF0] hover:bg-[#f87ff0b6] duration-300 text-white font-bold ${
                quantity === 5 && "!border-2 border-rose-500"
              }`}
            >
              5
            </button>
            <button
              ...
              className={`px-4 w-full py-2 rounded-3xl bg-[#F87FF0] hover:bg-[#f87ff0b6] duration-300 text-white font-bold ${
                quantity === 10 && "!border-2 border-rose-500"
              }`}
            >
              10
            </button>
