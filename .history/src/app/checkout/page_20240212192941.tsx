...
export const metadata: Metadata = {
  ...
  title: `Zaklejki.pl: Sklep z Naklejkami - `,
  description: `Ręcznie wycinana - Kup jedną z naszych naklejek i twórz własne. Naklejki złote, srebrne, holo. Naklejki na każdą okazję. Sklep z największą kolekcja naklejek ozdobnych.`,
  openGraph: {
    type: "website",
