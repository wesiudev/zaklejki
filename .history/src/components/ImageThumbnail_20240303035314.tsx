  ...
  return (
    <>
      ...
      >
        ...
        >
          <FaImage
            className={`group-hover:opacity-50 rounded-md absolute left-[50%] -translate-x-[50%] top-[50%] -translate-y-[50%] h-12 w-12 text-white`}
          />
          <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-4/5 h-auto overflow-hidden rounded-3xl mt-6">
