      ...
      <div className="grid grid-cols-2 lg:grid-cols-3 mt-3 gap-3 mb-3">
        {!cartItems?.some((item: any) => item?.size?.includes("small")) ? (
          <button
            ...
            className={`border-2 border-transparent px-4 w-full py-2 rounded-3xl bg-[#FAA4F4] hover:bg-[#f06be7] duration-300 text-white font-bold opacity-80 ${
              size === "small" && "!bg-[#f06be7] !border-[#f06be7] opacity-100"
            }`}
          >
            6cm
          </button>
        ...
        {!cartItems?.some((item: any) => item?.size?.includes("medium")) ? (
          <button
            ...
            className={`border-2 border-transparent px-4 w-full py-2 rounded-3xl bg-[#FAA4F4] hover:bg-[#f06be7] duration-300 text-white font-bold opacity-80 ${
              size === "medium" && "!bg-[#f06be7] !border-[#f06be7] opacity-100"
            }`}
          >
            8cm
          </button>
        ...
        {!cartItems?.some((item: any) => item?.size?.includes("large")) ? (
          <button
            ...
            className={`border-2 border-transparent px-4 w-full py-2 rounded-3xl bg-[#FAA4F4] hover:bg-[#f06be7] duration-300 text-white font-bold opacity-80 ${
              size === "large" && "!bg-[#f06be7] !border-[#f06be7] opacity-100"
            }`}
          >
            14cm
          </button>
      ...
      <div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-3 mt-3 gap-3">
          <button
            ...
            className={`border-2 border-[#f06be7] px-4 w-full py-2 rounded-3xl bg-[#FAA4F4] hover:bg-[#f06be7] duration-300 text-white font-bold ${
              paperType === "normal"
          ...
          <button
            ...
            className={`border-2 border-slate-500 px-4 w-full py-2 rounded-3xl bg-gradient-to-br from-slate-500 via-slate-400 to-slate-500 duration-300 text-white font-bold ${
              paperType === "silver" ? "opacity-100" : "opacity-80"
            }`}
          >
            Srebrny
          </button>
          <button
            ...
            className={`border-2 border-yellow-500 px-4 w-full py-2 rounded-3xl bg-gradient-to-br from-yellow-500 via-yellow-300 to-yellow-500 duration-300 text-white font-bold ${
              paperType === "gold" ? "opacity-100" : "opacity-80"
            }`}
          >
            Złoty
          </button>
