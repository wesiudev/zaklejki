          ...
          {cart?.length === 0 && (
            <div className="w-full h-screen fixed left-0 top-0 flex items-center justify-center flex-col bg-indigo-100">
              <div
                ...
                className="h-max w-max rounded-full bg-indigo-600 aspect-square border-indigo-300 border-[600px] flex items-center justify-center flex-col m-6 lg:p-12 xl:p-24"
              >
