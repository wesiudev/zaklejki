        ...
        <>
          {cart?.length === 0 && (
            <div className="w-full h-screen fixed left-0 top-0 flex items-center justify-center flex-col">
              <div className="h-max w-max rounded-full bg-indigo-600 aspect-square border-2 border-red-500 border-spacing-[100px] flex items-center justify-center flex-col p-6">
