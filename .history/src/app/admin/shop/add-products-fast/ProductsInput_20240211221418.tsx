...
export default function ProductsInputs({ files }: { files: any[] }) {
  ...
  async function upload(
    ...
    const resizeImage = async (buffer: ArrayBuffer) => {
      ...
      const resizedImage = image.resize({ width: 450 });
      return resizedImage.toBuffer("image/webp");
    };
