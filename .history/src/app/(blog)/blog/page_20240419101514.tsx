        ...
        <div className="bg-gray-200 p-3 lg:p-6 mt-12 prose lg:prose-xl min-w-[100%]">
          <div className="grid grid-cols-2 w-full h-max gap-4 mb-12">
            <Link href="/tworzenie-naklejek" className="relative">
              <div className="bg-black bg-opacity-50 bottom-0 p-3 left-0 text-white font-bold text-center">
            ...
            <Link href="/sklep" className="relative">
              <div className="bg-black bg-opacity-50 bottom-0 p-3 left-0 text-white font-bold text-center"></div>
              <Image
                src={"/3.jpeg"}
                width={1024}
                height={1024}
