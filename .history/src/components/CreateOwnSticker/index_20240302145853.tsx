...
export default function CreateOwnSticker() {
  ...
  return (
    <div className="">
      <div
        className={`bg-[#312E81] relative lg:rounded-xl px-6 py-6 -mr-4 lg:mr-0 flex flex-col text-white w-screen ld:w-[90vw] lg:w-[80vw] xl:w-[70vw] duration-500 overflow-y-scroll`}
      >
