    ...
    <>
      ...
      <main className="grid grid-cols-1 md:grid-cols-2 px-4 md:px-8 lg:px-12 xl:px-20 2xl:px-32">
        ...
        <div className="p-4 md:p-6 lg:p-8 xl:p-10 2xl:p-12 !pt-0 flex-col">
          ...
          <div className="flex flex-col">
            <h2 className="text-3xl font-bold h-12 mt-4">
          ...
          <div className="flex mt-12 flex-col">
            <h2 className="text-5xl">Cechy produktu:</h2>
            <ul>
              <li className="flex flex-row items-start mt-6">
                <div>
                  {" "}
                  <FaStar className="mr-2 text-yellow-400 h-5 w-5 text-5xl mt-[2px]" />
                </div>
                <strong>Wodoodporne</strong>: Naklejki są wykonane z wysokiej
                jakości materiałów, które zapewniają ochronę przed wilgocią i
                wodą. Możesz śmiało używać ozdobionych nimi przedmiotów nawet w
                deszczowe dni.
              </li>
              <li className="flex flex-row items-start mt-3">
                <div>
                  {" "}
                  <FaStar className="mr-2 text-yellow-400 h-5 w-5 text-5xl mt-[2px]" />
                </div>
                <strong>Estetyczny</strong> design: Oferujemy różnorodne wzory i
                kształty, które pozwolą Ci dopasować naklejkę do Twojego stylu.
                Od abstrakcyjnych motywów po urocze ilustracje – mamy wszystko,
                co potrzebne do stworzenia unikalnej aranżacji.
              </li>
              <li className="flex flex-row items-start mt-3">
                <div>
                  <FaStar className="mr-2 text-yellow-400 h-5 w-5 text-5xl mt-[2px]" />
                </div>
                <strong>Łatwe</strong> aplikowanie: Naklejki są łatwe do
                nakładania i usuwania, nie pozostawiając śladów ani uszkodzeń.
                Dzięki temu możesz zmieniać ich położenie i tworzyć nowe
