          ...
          <div className="z-20 opacity-0 group-hover:opacity-100 duration-300 absolute text-sm bottom-0 left-0 w-full flex flex-col items-center justify-center">
            <div className="flex flex-row">
              <div className="text-center flex flex-col items-center">
                ...
                <div className="bg-green-400 text-white font-light p-2 text-lg">
                  7,90zł
                </div>
              </div>
              <div className="text-center flex flex-col items-center">
                ...
                <div className="bg-blue-400 text-white font-light p-2 text-lg">
                  12,90zł
                </div>
              </div>
              <div className="text-center flex flex-col items-center">
                ...
                <div className="bg-yellow-400 text-white font-light p-2 text-lg">
                  17,90zł
                </div>
              </div>
            </div>
