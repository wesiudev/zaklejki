    ...
    <div className="h-max py-24 flex items-center justify-center text-center flex-col">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 relative h-full">
        <Image
          ...
          height={1080}
          alt={image2.alt}
          className="w-full rounded-3xl drop-shadow-xl shadow-pink-400 mt-12 lg:mt-0"
        />
        <div className="h-max sticky top-24">
          <h2 className="text-3xl text-zinc-800 drop-shadow-xl shadow-black font-druk mt-12 lg:mt-0">
            {firstH2.toUpperCase()}
          </h2>
          <p className="text-lg text-zinc-800 drop-shadow-xl shadow-black mt-12 lg:mt-0">
            {secondP}
          </p>
        </div>
      </div>
