...
export default function Home() {
  ...
  function getPrice(quantity: number, otherQuantity: number) {
  ...
  const [ownStickerOpen, setOwnStickerOpen] = useState(false);
  return (
    <>
      {checkoutOpen && (
        <div className="z-50 fixed left-1/2 top-1/2 -translate-y-1/2 -translate-x-1/2 w-max h-[80vh] overflow-y-scroll bg-white shadow-lg shadow-black rounded-xl">
          <div className="bg-[#312E81] rounded-xl px-6 w-full h-max py-12 flex flex-col text-white">
            <CheckoutSummary
              setCheckoutOpen={setCheckoutOpen}
              price={getPrice(quantity, otherQuantity)}
              quantity={quantity}
            />{" "}
            ...
            <StripeButton
              ...
              price={getPrice(quatity, otherQuantity)}
              acceptedTerms={customerInfo.acceptedTerms}
      ...
      <main className="grid grid-cols-1 md:grid-cols-2 px-4 md:px-8 lg:px-12 xl:px-20 2xl:px-32">
        <div className="flex flex-col">
          <div className="flex flex-col gap-3 h-max md:sticky xl:relative md:top-12 xl:top-0">
            <div className="">
              <Image
        ...
        <div className="md:p-6 lg:p-8 xl:p-10 2xl:p-12 !pt-0 flex-col">
          <p className="mb-3 text-gray-400">8531 wyświetleń</p>
          <div className="my-3">
            <p>
          ...
          <div className="grid grid-cols-3 mt-6 mb-3   gap-3">
            ...
            <input
              ...
              onChange={(e: any) => {
                setOtherQuantity(e.target.value), setQuantity(0);
              }}
          ...
          <div className="flex flex-col">
            <span className="text-3xl font-bold h-12 mt-4">
              {getPolishCurrency(getPrice(quatity, otherQuantity))}
            </span>
          ...
          <div className="flex mt-12 flex-col">
            <h2 className="text-4xl font-bold">Cechy produktu:</h2>
            <ul>
