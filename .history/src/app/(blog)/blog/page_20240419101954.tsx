    ...
    <div className="mt-[66px] font-sans ">
      ...
      >
        ...
        <div className="bg-gray-200 p-3 lg:p-6 mt-12 prose lg:prose-xl min-w-[100%]">
          <div className="grid grid-cols-1 md:grid-cols-2 w-full h-max gap-4 mb-12">
            <Link href="/tworzenie-naklejek" className="relative">
              <div className="bg-black bg-opacity-50 bottom-0 p-3 left-0 text-white font-bold text-center absolute">
                <h2 className="text-sm sm:text-base">Stwórz własną naklejkę</h2>
                <p className="text-sm text-justify">
                  Utwórz design swojej własnej naklejki, a my zajmiemy się
                  resztą.
                </p>
              </div>
              <Image
            ...
            <Link href="/sklep" className="relative">
              <div className="bg-black bg-opacity-50 bottom-0 p-3 left-0 text-white absolute">
                <h2 className="text-sm sm:text-base font-bold text-center">
                  Zobacz sklep z naklejkami
                </h2>
                <p className="text-sm text-justify">
                  Przeglądaj naszą kolekcję ponad 2000 unikalnych naklejek.
                </p>
              </div>
              <Image
                src={"/3.jpeg"}
